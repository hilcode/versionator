...
public final class PropertySetter
{
	...
	public void updateProperty(final File pomFile, final String key, final String value)
	{
		final String xpath = String.format("/project/properties/%s/text()", key);
		...
		if (vtdGenerator.parseFile(pomFile.getPath(), true))
		{
			...
			while (true)
			{
				...
				updateToken(xmlModifier, index, value);
			}
